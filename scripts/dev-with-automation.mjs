...
function showHelp() {
  console.log(`
AUTO/MATE + Automation Development Stack
...
function printBanner(config) {
  const stackName = config.frontendOnly
    ? "AUTO/MATE Frontend Stack"
    : config.backendOnly
      ? "AUTO/MATE Backend Stack"
      : "AUTO/MATE + Automation Stack";
...
async function main(options = {}) {
  const {
    bannerTitle = "AUTO/MATE + Automation Development Stack",
