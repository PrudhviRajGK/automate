/**
 * electron-builder configuration for the AUTO/MATE desktop app.
 *
 * NOTE: `productName` is the packaged-app *filename* (AUTO-MATE.app,
 * AUTO-MATE Setup.exe), and "/" is illegal in filenames on every target
 * platform — so the packaged name uses a hyphen while the UI, banners and
 * docs use the real brand, AUTO/MATE.
 *
...
const config = {
  ...
  dmg: {
    ...
    // Default is "AUTO-MATE-<version>-<arch>.dmg"; GitHub release
    ...
    artifactName: "AUTO-MATE-${version}-${arch}.${ext}",
  },
  ...
  nsis: {
    ...
    // The default artifact name is "AUTO-MATE Setup <version>.exe";
    ...
    artifactName: "AUTO-MATE-Setup-${version}.${ext}",
  },
