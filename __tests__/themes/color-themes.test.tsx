...
describe("color themes", () => {
  it("includes AUTO/MATE-Neo as a neutral-based theme with white button tokens", () => {
    const neo = COLOR_THEMES["openhands-neo"];

    expect(neo.label).toBe("AUTO/MATE-Neo");
  ...
  it("injects white primary tokens when applying AUTO/MATE-Neo", () => {
