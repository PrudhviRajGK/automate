...
const PRODUCT_FILENAME = "AUTO-MATE";
...
// Neither one implies the other — the packaged app shipped with a
// CFBundleName that disagreed with app.name until both were set. Pin them
// together so they can't drift again.
//
// Both use "AUTO-MATE", not the brand's "AUTO/MATE": this string becomes a
// filename (AUTO-MATE.app) and "/" is not a legal filename character.
