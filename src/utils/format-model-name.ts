...
export const FREE_OPENHANDS_MODELS = {
  "openhands/deepseek-v4-flash": "AUTO/MATE DeepSeek V4 Flash (free)",
} as const;
...
export const FREE_OPENHANDS_MODEL_NOTE = `Free AUTO/MATE models: ${FREE_OPENHANDS_MODEL_IDS.join(
  ", ",
