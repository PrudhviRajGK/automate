...
* target="cloud" — runs on AUTO/MATE Cloud in its own isolated sandbox, from a
  ...
  to have an AUTO/MATE Cloud backend connected in AUTO/MATE; if none is
  ...
  parameters: {
    ...
    properties: {
      target: {
        ...
        description:
          "Where the child runs. 'local' reuses this machine and this conversation's workspace; 'cloud' runs in an isolated AUTO/MATE Cloud sandbox.",
      },
      task: {
        type: "string",
        description:
