 ...
 * additionally includes the native built-in harness.
 */
...
export function AgentBrandIcon({
  ...
  if (kind === "openhands") {
    // The AUTO/MATE mark is a square emoji glyph, so it takes the same box as
    // the ACP brand marks below — no aspect-ratio or fill fixups needed.
    return (
      <AutoMateLogo
        width={size}
        height={size}
