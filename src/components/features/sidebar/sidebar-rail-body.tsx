...
import { BrandLogoButton } from "#/components/shared/buttons/brand-logo-button";
...
import { ISSUE_REVIEW_COPY } from "#/components/features/issue-review/issue-review-copy";
import {
...
const ICON_SIZE = 18;
const ISSUE_REVIEW_PATH = "/issues";
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col">
      ...
      <nav className={sidebarNavListClassName(collapsed)}>
        ...
        {/* Demo surface: the seeded issue review queue. */}
        <SidebarNavLink
          to={ISSUE_REVIEW_PATH}
          label={ISSUE_REVIEW_COPY.pageTitle}
          testId="sidebar-issues-link"
          collapsed={collapsed}
          icon={<ClipboardCheck width={ICON_SIZE} height={ICON_SIZE} />}
          pinAction={buildPinAction(
            ISSUE_REVIEW_PATH,
            "sidebar-pin-home-toggle-issues",
          )}
        />
