...
description: Repository-specific review rules for the AUTO/MATE frontend.
triggers:
  - /codereview
---

# AUTO/MATE Code Review Guidelines

This guide supplements the public `code-review` skill with rules specific to
`OpenHands/OpenHands`, the AUTO/MATE frontend. Read `AGENTS.md` first; it is
...
| Repository                     | Owns                                                                                                            |
| ------------------------------ | --------------------------------------------------------------------------------------------------------------- |
| `OpenHands/OpenHands`          | AUTO/MATE UI, frontend state, backend selection, frontend service integration, and local-stack orchestration |
